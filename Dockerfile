...
WORKDIR ${GOPATH}/src/github.com/pipl/kpis-action-slack-notify
COPY main.go ${GOPATH}/src/github.com/pipl/kpis-action-slack-notify
COPY go.mod ${GOPATH}/src/github.com/pipl/kpis-action-slack-notify
